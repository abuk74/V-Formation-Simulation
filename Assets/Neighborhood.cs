...
public class Neighborhood : MonoBehaviour
{
    ...
    public Vector3 avgClosePos
    {
        get
        {
            ...
            //Jeśli nie ma boidów znajdujących się zbyt blisko, zwróć Vector3.zero
            if (nearCount == 00) return avg;
            //W przeciwnym razie zwróć ich położenie
            avg /= nearCount;
            return avg;
        }
    }
